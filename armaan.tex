...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.S. in Applied Math \& Statistics and B.A. in Biophysics; Junior; 4.00 GPA}{Aug. 2022 -- June 2026}
    \resumeSubheading
...
\section{Skill Set}
  \resumeSubHeadingListStart
      \resumeSubItem{Programming: }
        {Python, Java, Bash, Javascript, HTML, CSS}
      \resumeSubItem{Typesetting: }
        {LaTeX, Markdown, Microsoft Office, LibreOffice}
      \resumeSubItem{Research: } {Probability, Bioinformatics, Molecular Dynamics, Monte Carlo Simulations, Wet-lab techniques}
  \resumeSubHeadingListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItemSpace{Computational design of robust diagnostic tool:}{Conducted bioinformatic research under Dr. Will Dampier at the Wigdahl Laboratory developing clinically relavent probes against HIV-1 drug resistance using the novel SHERLOCK technology. Designed varient-resistant LAMP primers and gRNAs.}
      \resumeItemSpace{In vitro validation:}{
      ...
      \resumeItemSpace{Patient-varient HIV-1 amplification and sequencing:}{Performed PCR amplification of patient HIV-1 samples and ran a subset of them through a Nanopore sequencer}
    \resumeItemListEnd
...
\section{Manuscripts}
  ...
  \resumeSubItem{}
    {Manojlovi\'c, V.*, \textbf{Ahmed, A.*}, Viossat, Y., Noble, R. (2024). Expected and minimal values of a universal tree balance index. \textit{In preparation}.}\footnotetext[1]{These authors contributed equally to the work.}
  \resumeSubItem{}
...
\section{Conferences and Workshops}
  ...
  \resumeSubItem{}
    {Yang, R., Wang, C., \textbf{Ahmed, A.}, Grigorev, V., Moulick, R., Woodson, S., \& Zhang, Y. (2024). Exchange Dynamics of Single Molecule in Phase Separated Droplet. Institute of Biophysical Research Retreat, Washington D.D.}
  \resumeSubItem{}
...
\section{Relevant Coursework}
  ...
  \begin{multicols}{3}
    \begin{itemize}[leftmargin=*]
      ...
      \item Stochastic Processes \& Applications to Finance I (553.627; A+)
