...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
    {Undergraduate Teacher Assistant/Learning Assistant}{Baltimore, MD}
    {}{Jan 2024 - Present}
    \resumeItemListStart
      \resumeItem{Intro to Computing Teacher Assistant:}
        {Hold office hours for students, grade assignments, and assist in class.}
      \resumeItem{Physics II Learning Assistant:}
