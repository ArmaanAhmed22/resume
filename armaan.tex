...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{Elmhurst Hospital Intern}{Queens, NY}{Student Researcher and Intern}{Jul 2022 - Present}
    \resumeItemListStart
      \resumeItem{2023 Summer Hospital Volunteer:}
        {Performed clinical work, shadowing, and research. Called on patients, asked questions, and obtained consent forms. Watched surgeries in the operating rooms, including open, laporoscopic, and robotic. Wrote different case reports and performed database analyses.}
