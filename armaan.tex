  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{2023 Summer Hospital Volunteer:}
        {Performed clinical work, shadowing, and research. Called on patients, asked questions, and obtained consent forms. Watched surgeries in the operating rooms, including open, laporoscopic, and robotic. Aided in different case reports and performed database analyses.}
...
\section{Peer-reviewed publications}
  ...
  \resumeSubItem{}
    {\textbf{Ahmed, A.}, Whittington, J., \& Shafaee, Z. (2023). Impact of Commission on Cancer Accreditation on Cancer Survival: A SEER Database Analysis. \textit{Annals of Surgical Oncology}. In press.}
  \end{enumerate}
  \vspace{-4pt}
...
\section{Relavent Coursework}
  ...
  \begin{multicols}{3}
    \begin{itemize}[leftmargin=*]
      ...
      \item Organic Chemistry Lab (030.225; A)
      \item[\vspace{\fill}]
    \end{itemize}
...
\section{Awards}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{Dean's List (2x)}{Baltimore, MD}{The Johns Hopkins University}{Jan 2023}
...
\section*{Extracurricular Activities}
  ...
  \resumeSubheading
    {Johns Hopkins Learning Den}{Baltimore, MD}
    {Tutor}{September 2023 - Present}
    \resumeItemListStart
      \resumeItem{Learning Den Personalized Tutor:}
        {I tutor students on subjects ranging from Organic Chemistry to Honors Linear Algebra.}
    \resumeItemListEnd
