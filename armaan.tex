...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.S. in Applied Math \& Statistics; Junior; 4.00 GPA}{Aug. 2022 -- June 2026}
    \resumeSubheading
...
\section{Skill Set and Interests}
  \resumeSubHeadingListStart
      ...
      \resumeSubItem{Research: } {Cancer/Population Models, Stochastic Processes, Analysis, Probability, Monte Carlo Simulations}
  \resumeSubHeadingListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemSpace{Investigating the site frequency spectrum in an exponentially growing tumor with driver mutations:}
          {Theoretically examining the distribution of neutral and driver mutation (the latter increases the birth rate) frequencies in a cell population growing exponentially.}
...
\section{Manuscripts \& Preprints}
  ...
  \resumeSubItem{}
    {Patil, S., \textbf{Ahmed, A.}, Viossat, Y., \& Noble, R. (2024). Preventing Evolutionary Rescue In Cancer. \textit{biorxiv}. doi:\href{https://doi.org/10.1101/2023.11.22.568336 }{\underline{10.1101/2023.11.22.568336}}. \textit{(Review  \& Resubmit to Genetics)}}
  \resumeSubItem{}
