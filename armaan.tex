...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Intro to Computing Teacher Assistant (Spring, 2024):}
        {Hold office hours for students, grade assignments, and assist in class.}
      \resumeItem{Physics II Learning Assistant (Spring, 2024):}
        {Assist students during discussion section on problem sets.}

      \resumeItem{Learning Den Personalized Tutor (Fall, 2023):}
...
\section{Peer-reviewed publications}
  ...
  \resumeSubItem{}
    {Patil, S., \textbf{Ahmed, A.}, Viossat, Y., \& Noble, R. (2024). Preventing Evolutionary Rescue In Cancer. \textit{In preparation}}
  \resumeSubItem{}
