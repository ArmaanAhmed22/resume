...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.S. in Biomedical Engineering and B.A. in Biophysics; Freshman; 4.00 GPA}{Aug. 2022 -- June 2026}
    \resumeSubheading
      {Scarsdale High School}{Scarsdale, NY}
      {High School Diploma;  4.00 (4.15/4.30) GPA}{Aug. 2008 -- July. 2012}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Rational protein engineering:}
          {Worked with graduate student Jimin Kang to computationally design thermostable DNMT1 methyltransferase variants. Generated in silico mutation libraries and selected top candidatesby using metal cofactor, DNA, and SAM binding screens. Performed MD simulations to verify thermostability using NAMD}
...
\section{Relavent Coursework}
  ...
  \textit{(Unofficial transcript available \href{https://raw.githubusercontent.com/ArmaanAhmed22/resume/master/Transcript.pdf}{here})}
  ...
  \begin{multicols}{3}
    \begin{itemize}[leftmargin=*]
      ...
      \item Honors Multivariable Calculus (110.211)
      \item Differential Equations (110.302)
      \item Honors Linear Algebra (110.212; A+)
      \item General Physics I (171.101; A+)
      \item General Physics II (171.102)
      \item Honors Organic Chemistry II (030.212)
      \item Introductory Organic Chemistry I (030.205; A)
      \item Organic Chemistry Lab (030.225)
      \item[\vspace{\fill}]
    \end{itemize}
...
\section*{Extracurricular Activities}
  ...
  \resumeSubheading
    ...
    {Writer}{Jan 2023 - Present}
    \resumeItemListStart
      \resumeItem{Volunteer writer for the SciTech column:}
  ...
  \resumeSubheading{Ex-Numera}{Baltimore, MD}{Website Designer and Member}{Feb 2023 - Present}
  \resumeItemListStart
    \resumeItem{Reviving the Johns Hopkins University's math club:}
      {I am currently working with a team of students to revitalize the Johns Hopkins University's math club. I am in the process of revamping the old website.}
  \resumeItemListEnd
